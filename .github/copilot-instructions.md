...
# Meridian workspace instructions

This workspace uses the `meridian-brain` MCP server as the canonical source of Meridian runtime state, retrieved operating context, and durable memory.
...
3. Build the live Meridian system prompt from the current shared state and retrieved context.
